...
contract Base is AzosTest {
  ...
  function _mockOracleRelayerMarketPrice(
    uint256 _result
  ) internal {
    vm.mockCall(
...
contract Unit_PIDRateSetter_ModifyParameters is Base {
  ...
  function test_ModifyParameters_Set_OracleRelayer(
    address _oracleRelayer
  ) public authorized mockAsContract(_oracleRelayer) {
  ...
  function test_ModifyParameters_Set_PIDCalculator(
    address _pidCalculator
  ) public authorized mockAsContract(_pidCalculator) {
...
contract Unit_PIDRateSetter_UpdateRate is Base {
  ...
  function test_Revert_NullPrice(
    UpdateRateScenario memory _scenario
  ) public {
